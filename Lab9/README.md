...
- Шедулер: `Lab9/lib/scheduler.h` (класс `TTaskScheduler`, зависимости через `FutureResult<T>`).
- Пример: `Lab9/bin/main.cpp`.
- Тесты: `Lab9/tests` 
- Сборка: из `Lab9/` — `cmake -S . -B build`, `cmake --build build`.
