...
TEST_P(OperationTestsSuite, AddAndAssignTest) {
    uint239_t a = FromString(std::get<0>(GetParam()).first, std::get<0>(GetParam()).second);
    uint239_t b = FromString(std::get<1>(GetParam()).first, std::get<1>(GetParam()).second);
...
TEST_P(OperationTestsSuite, SubtractAndAssignTest) {
    uint239_t a = FromString(std::get<0>(GetParam()).first, std::get<0>(GetParam()).second);
    uint239_t b = FromString(std::get<1>(GetParam()).first, std::get<1>(GetParam()).second);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        std::make_tuple(TValue{"11", 0}, TValue{"11", 0}, TValue{"22", 0}, TValue{"0", 0},  TValue{"121", 0}, TValue{"1", 0}),
