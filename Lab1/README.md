[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=16015031&assignment_repo_type=AssignmentRepo)
# Лабораторная работа 1

## Реализация в этом репозитории

- Код: `Lab1/main.cpp` .
- Сборка: из `Lab1/` — `cmake -S . -B build` и `cmake --build build`.
- Запуск: в текущей версии входной файл ожидается как последний аргумент и должен называться `access_log.txt`.
